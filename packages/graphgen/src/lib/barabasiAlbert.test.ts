...
describe('barabasiAlbert scale', () => {
  it('scales heterogeneity in the range [0, 0.5] to [0, 1]', () => {
    expect(
      prismDecimal0n.reverseGet(scaleNLPAHeterogeneity(castHeterogeneity(0)))
    ).toBeCloseTo(0);
    expect(
      prismDecimal0n.reverseGet(scaleNLPAHeterogeneity(castHeterogeneity(0.25)))
    ).toBeCloseTo(0.5);
    expect(
      prismDecimal0n.reverseGet(scaleNLPAHeterogeneity(castHeterogeneity(0.5)))
    ).toBeCloseTo(1);
  });
  ...
  it('scales heterogeneity in the range (0.5, 1] to (1, n]', () => {
    ...
    expect(
      prismDecimal0n.reverseGet(scaleNLPAHeterogeneity(castHeterogeneity(0.75)))
    ).toBeCloseTo(1.5);
    expect(
      prismDecimal0n.reverseGet(scaleNLPAHeterogeneity(castHeterogeneity(1)))
    ).toBeCloseTo(2);
  });
});
