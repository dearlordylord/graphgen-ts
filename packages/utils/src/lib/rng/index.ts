...
export const prismRandom01 = prismDecimal01.compose(
  prism<Random01>(flow(prismDecimal01.reverseGet, (n) => n < 1))
);
export const castRandom01 = castToPrism(prismRandom01)(
  (n) => `Invalid cast, prismRandom01 is not in range 0-1: ${n}`
);
